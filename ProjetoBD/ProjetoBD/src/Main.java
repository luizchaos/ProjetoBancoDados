...
public class Main {
	...
	public static void main(String[] args) {
		...
		//exclusao
		venda_LancheController.remover(entityManager, semana6venda_lanche5);
		lancheController.remover(entityManager, semana6lanche5);
		vendaController.remover(entityManager, semana6venda5);
		clienteController.remover(entityManager, semana6cliente5);
		enderecoController.remover(entityManager, semana6endereco5);
		cidadeController.remover(entityManager, semana6cidade5);
		estadoController.remover(entityManager, semana6estado5);
		...
		//Relatorio 1
		//Relatorio de clientes e sua localizacao(inner com estado, cidade)
		
		List<Cliente> listCliente = clienteController.listar(entityManager); 
		System.out.println("Relatorio de Clientes e sua Localizacao!");
		System.out.println("");
		for(Cliente c : listCliente) {
			...
			System.out.print(c.getEndereco().getRua()+", ");
			System.out.print(c.getEndereco().getNumero()+", ");
			System.out.print(c.getEndereco().getCidade().getDescricao()+", ");
			System.out.print(c.getEndereco().getCidade().getEstado().getDescricao()+"");
			System.out.println("");
		}
		...
		//Relatorio 2 
		//Relatorio de vendas de lanche (inner com lanche, venda)
		
		List<Venda_Lanche> listVendaLanche = venda_LancheController.listar(entityManager);
		System.out.println("Relatorio de vendas de lanches!");
		System.out.println("");
		for(Venda_Lanche v : listVendaLanche) {
			System.out.print(v.getVenda().getNumNotaFiscal()+", ");
			System.out.print(v.getLanche().getDescricao()+", ");
			System.out.print(v.getLanche().getPreco().toString()+"");
			System.out.println("");
		}
